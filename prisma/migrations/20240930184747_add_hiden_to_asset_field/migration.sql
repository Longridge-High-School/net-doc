...
INSERT INTO "new_AssetField" ("assetId", "displayOnTable", "fieldId", "helperText", "id", "order") SELECT "assetId", "displayOnTable", "fieldId", "helperText", "id", "order" FROM "AssetField";
